...
Pot1_ph = {"type":"SensorPh_ADS1115", # The name of the python class to use
            ...
            "average_over_samples":20, # Keep running average of last n samples
...
Pot1_ControlPh= {"type":"ControlPh", # The object type we are creating
                ...
                "minimum_time_between_actions":600.0, # Minimum amount of time between actions for this control
                ...
                "mL_per_control":1 # mL to dispense per action
                }
...
world = {"name":"world",
        "type":"World",
        "output_type":"csv",
        "csv_name":"diode_test.csv",
        #"csv_name":"data_out_tank_add_8ml_down.csv",
        "main_loop_min_time":1.0, # the minimum time between looping over everything, prevents tight loop
